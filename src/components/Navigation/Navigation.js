    ...
    < div className={`burger-menu ${isBurgerOpen ? 'burger-menu_opened' : ' '}`}>
      <div className='burger-menu__container'>
        ...
        <div className="burger-menu__links">
          <NavLink className={({ isActive }) => (isActive ? "burger-menu__link burger-menu__link_active" : "burger-menu__link")} to="/" >Главная</NavLink>
          <NavLink className={({ isActive }) => (isActive ? "burger-menu__link burger-menu__link_active" : "burger-menu__link")} to="/movies">Фильмы</NavLink>
          <NavLink className={({ isActive }) => (isActive ? "burger-menu__link burger-menu__link_active" : "burger-menu__link")} to="/saved-movies">Сохранённые фильмы</NavLink>
        </div>
