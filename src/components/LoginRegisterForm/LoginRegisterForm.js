...
function LoginRegisterForm({ greetings, submitText, inputs, isInRigister }) {
  return (
    <section className="login-register">
      <NavLink to="/"><img className="login-register__logo logo" src={Logo} alt="логотип" /></NavLink>
      ...
      {isInRigister ?
        ...
        :
        (<span className="login-register__span">Еще не зарегистрированы <NavLink to="/signup"><button className="login-register__bth-enter">Регистрация</button></NavLink></span>)}
    </section >
  )
}
